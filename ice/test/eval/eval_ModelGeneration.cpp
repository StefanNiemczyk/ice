...
TEST(EvalModelGeneration, simpleEvalTests)
{
  ...
  scenarios2.chainScenario(          true,       false,  false,          runs,      10, 10, 1, 10, 10, 10);
...
//  scenarios.representationScenario(  false,      false,  false,          runs,      9, 9, 1);
  ...
  scenarios.systemsStarMashScenario( false,      false,  false,          runs,      false, 10, 150, 1, 1, 149, 1);
//  scenarios.systemsFullMashScenario( false,      false,  false,          runs,      10, 20, 1);
  scenarios.chainScenario(           false,      false,  false,          runs,      1, 1, 1, 10, 500, 10);
}
