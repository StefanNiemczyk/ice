...
//  scenarios.chainScenario(           false,      false,  false,          runs,      10, 10, 1, 10, 10, 1);
...
//    asp->setPredefConfiguration(supplementary::PredefinedConfigurations::jumpy);
  ...
  //                                 global      verbose gnuplot         runs
//  scenarios2.chainScenario(          true,       false,  false,          runs,      10, 10, 1, 10, 10, 1);
//  scenarios2.representationScenario( true,       false,  true,          runs,      2, 9, 1);
  scenarios2.systemsStarMashScenario(true,       true,  true,          runs,      true, 10, 50, 10);
//  scenarios2.systemsStarMashScenario(true,       true,  true,          runs,      false, 10, 500, 10);
