...
//  oi.saveOntology("/tmp/evalSimpleTest.owl");
  ...
  toCheck.push_back("selectedStream(1,testSystem,testSourceNodeInd,testSystem,information(testEntityInd,testScope,testRep1,none),0)");
  toCheck.push_back("sumCost(1,5)");
  toCheck.push_back("node(1,testSystem,testSourceNodeInd,testEntityInd,none)");
  toCheck.push_back("metadataStream(1,delay,testSystem,testSourceNodeInd,testSystem,information(testEntityInd,testScope,testRep1,none),0,5)");
  toCheck.push_back("metadataStream(1,accuracy,testSystem,testSourceNodeInd,testSystem,information(testEntityInd,testScope,testRep1,none),0,90)");
