...
rapidjson::Value RequestMessage::payloadToJson(rapidjson::Document &document)
{
...
bool RequestMessage::parsePayload(rapidjson::Value& value, std::shared_ptr<GContainerFactory> factory)
{
  this->requests.clear();
