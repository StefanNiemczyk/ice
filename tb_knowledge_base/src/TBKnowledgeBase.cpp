...
TBKnowledgeBase::TBKnowledgeBase()
{
  ...
  ice::Node::registerNodeCreator("Pos3D2RelativeToLandmarkSet", &VictimDetection::createNode);
  ice::Node::registerNodeCreator("RelativeToLandmark2Pos3DSet", &VictimDetection::createNode);
}
